...
- Respostas focadas exclusivamente em programação Python
- Explicações conceituais + exemplos práticos de código
- Comentários detalhados explicando cada trecho do código
- Referências diretas à documentação oficial do Python ou bibliotecas utilizadas
- Histórico de conversas persistente durante a sessão
- Integração com modelos LLM via Groq API
